...
// File: index.js - IPC/RPC module startup file
	...
	exports.add = function add(DD_MODULES) {
		...
		DD_MODULES[MODULE_NAME] = {
			...
			create: function create(root, /*optional*/_options) {
				...
				return modules.load(MODULE_NAME, (fromSource ? 'src/server/Server_Ipc.js' : 'Server_Ipc.min.js'), _options)
					.then(function() {
						// Returns nothing
					});
			},
